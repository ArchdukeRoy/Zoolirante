...
namespace Zoolirante.Controllers
{
    public class EventsController : Controller
    {
        ...
        public EventsController(ZooliranteContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("EventId,Name,Description")] Event @event)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("EventId,Name,Description")] Event @event)
        {
            if (id != @event.EventId)
            {
                return NotFound();
